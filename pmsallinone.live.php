...
//echo $accountName;
exec("cd /home/" . $accountName. "/repositories && pwd 2>&1",$output);
var_dump($output);

// exec("git", $output);
exec("git clone https://xmltech:ATBB6LB7eg4Nw3TVvQfeT2umUru69DD05C56@bitbucket.org/xmltech/allinone-v2.git 2>&1", $output);
var_dump($output);
